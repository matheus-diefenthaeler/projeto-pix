...
import br.com.bacen.grupo3.client.AdaClient;
import br.com.bacen.grupo3.client.ItauClient;
...
import br.com.bacen.grupo3.exception.ContaInvalidaException;
import br.com.bacen.grupo3.mapper.TransferenciaMapper;
import br.com.bacen.grupo3.model.Transferencia;
import br.com.bacen.grupo3.repository.TransferenciaRepository;
...
public class TransferenciaService {
    ...
    private void validarConta(TransferenciaRequest transferenciaRequest) {
        ...
        if (transferenciaRequest.getInstituicaoFinanceiraDestino().equals("ADA LETS CODE S.A.")) {
